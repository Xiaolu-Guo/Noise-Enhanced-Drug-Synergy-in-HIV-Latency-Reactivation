function [ReacRatio,MFPT_GFPmoreThresh,all_reac] = LTR4State_TatPosFeed_SSA_ReacRatio_MFPT_CellCycle_v2...
...
%     plot(T(i_cell,Tat(i_cell,:)>0),Tat(i_cell,Tat(i_cell,:)>0)); hold on
% end
